...
find /cluster/scratch/hhussein/Structures/set1 -name "*_complex.pdb" | shuf | parallel -j 24 -n 1 --ungroup  bash -c ": && make_rosetta {}"
find /cluster/scratch/hhussein/Structures/set2 -name "*_complex.pdb" | shuf | parallel -j 24 -n 1 --ungroup  bash -c ": && make_rosetta {}"
fi
