...
find /cluster/scratch/hhussein/Structures/set1 -name "*_ligand.mol2" | parallel -n 1 bash -c ": && make_params_pdb {}"
find /cluster/scratch/hhussein/Structures/set2 -name "*_ligand.mol2" | parallel -n 1 bash -c ": && make_params_pdb {}"
#make_params_pdb $1
