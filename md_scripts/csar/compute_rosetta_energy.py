...
def get_files(folder):
  return list(folder.glob('*/*/*_complex_*.pdb'))
...
if __name__ == "__main__":
  p = Pool(48)
  #extract_and_save(Path('/cluster/scratch/hhussein/pdbbind2018/10gs/10gs_complex_0002.pdb'))
  p.map(extract_and_save, get_files(Path('/cluster/scratch/hhussein/Structures/')))
  #print(len(get_fix_files(Path('/cluster/scratch/hhussein/pdbbind2018/'))))
  #update_radii_charges(Path('/cluster/scratch/hhussein/pdbbind2018/10gs/10gs_complex_0002.pdb'))
  #p.map(update_radii_charges, get_fix_files(Path('/cluster/scratch/hhussein/pdbbind2018/')))
