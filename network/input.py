...
import numpy as np
from Repo.network.utils import random_rot, rots_90, random_rot_90, all_rot_90
...
def make_input_fn(input_path, shape, training, rot, merge):
    def in_fn():
        ...
        seed_t = tf.py_func(lambda : random.randint(0,2147483647), [], tf.int64)
...
def load_fn(dataset_object, channels, rotate, training):
	...
	return make_input_fn(dataset, shape, training, rotate, channels)
